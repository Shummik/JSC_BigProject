            ...
            const postData = (body, outputData, errorData) => {
                ...
                request.addEventListener('readystatechange', () => {
                    if (request.readyState !== 4) {
                        /*  состояние readyState 0 - начальное, 1 - open уже вызван, 
                        2 - метод send и получены заголовки, 
                        3 - загружается тело и содержится часть данных
                        4 - приходит ответ "ок" от сервера */
                       return;
                    }
